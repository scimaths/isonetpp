...
class OurMatchingModelSubgraphIsoData(object):
  ...
  def load_graphs(self):
    ...
    if self.mode == "Extra_test_300":
        fp = self.av.DIR_PATH + "/velugoti_dataset/Datasets/splits/Extra_test_300/test_" +self.av.DATASET_NAME +"_240k_query_subgraphs.pkl"
    else:
        fp = self.av.DIR_PATH + "/velugoti_dataset/Datasets/splits/" + self.mode + "/" + self.mode + "_" +\
    ...
    if self.mode == "Extra_test_300":
        fp = self.av.DIR_PATH + "/velugoti_dataset/Datasets/splits/Extra_test_300/test_" +self.av.DATASET_NAME + "_240k_rel_nx_is_subgraph_iso.pkl"
    else:
        fp = self.av.DIR_PATH + "/velugoti_dataset/Datasets/splits/" + self.mode + "/" + self.mode + "_" +\
    ...
    fp = self.av.DIR_PATH + "/velugoti_dataset/Datasets/splits/" + self.av.DATASET_NAME +"240k_corpus_subgraphs.pkl"
