...
class BaselineMLP(nn.Module):
    def __init__(self, input_dim, hidden_dim, dropout, n_layers, conv_type, skip, post_mp_dim):
        super(BaselineMLP, self).__init__()
        self.emb_model = SkipLastGNN(input_dim, hidden_dim, dropout, n_layers, conv_type, skip, post_mp_dim)
...
class OrderEmbedder(nn.Module):
    def __init__(self, input_dim, hidden_dim, margin, dropout, n_layers, conv_type, skip, post_mp_dim):
...
class SkipLastGNN(nn.Module):
    def __init__(
        ...
        self.post_mp = nn.Sequential(
            ...
            nn.ReLU(),
            nn.Linear(hidden_dim, post_mp_dim), nn.ReLU(),
            nn.Linear(post_mp_dim, hidden_dim))
...
class NeuroMatch(OrderEmbedder):
    def __init__(
        self,
        input_dim,
        hidden_dim,
        ...
        super(NeuroMatch, self).__init__(input_dim, hidden_dim, margin, dropout, n_layers, conv_type, skip, post_mp_dim)
