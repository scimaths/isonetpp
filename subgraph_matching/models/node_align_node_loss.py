...
class NodeAlignNodeLoss(torch.nn.Module):
    def __init__(
        ...
        self.graph_size_to_mask_map = model_utils.graph_size_to_mask_map(
            max_set_size=max_set_size, lateral_dim=sinkhorn_feature_dim, device=self.device
        )
    ...
    def forward(self, graphs, graph_sizes, graph_adj_matrices):
        ...
        stacked_features_query, stacked_features_corpus = model_utils.split_and_stack(node_features_enc, graph_sizes, self.max_set_size)
